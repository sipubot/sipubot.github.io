...
i.fillRect(t.x-t.width/2,t.y-t.height/2,t.width,t.height)});var s=this.boss;this.boss.hp>0&&(i.fillStyle="rgb(255,"+Math.floor(s.hp/4).toString()+",11)",i.fillRect(s.x-s.width/2,s.y-s.height/2,s.width,s.height)),
