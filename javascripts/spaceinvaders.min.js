...
this.IntroStageWord="This is Just Game"}function Ship(t,e){this.x=t,this.y=e,this.width=80,this.height=42}function Rocket(t,e,i){this.x=t,this.y=e,this.velocity=i;
}function Bomb(t,e,i){this.x=t,this.y=e,this.velocity=i}function BossBomb(t,e,i,s){this.x=t,this.y=e,this.direction=i,this.velocity=s}function ExplosionBoss(t,e,i,s){
...
s||o||n||(h.x=a,h.y=l)}),this.invadersAreDropping&&(this.invaderCurrentDropDistance+=this.invaderVelocity.y*e,this.invaderCurrentDropDistance>=this.config.invaderDropDistance&&(this.invadersAreDropping=!1,
...
}),this.bossexplosion.map(function(t,i){switch(t.direction){case 0:t.y+=e*t.velocity,t.x-=e*t.velocity;break;case 1:t.y+=e*t.velocity;break;case 2:t.y+=e*t.velocity,
t.x+=e*t.velocity;break;case 3:t.y-=e*t.velocity,t.x-=e*t.velocity;break;case 4:t.y-=e*t.velocity;break;case 5:t.y-=e*t.velocity,t.x+=e*t.velocity}}),n&&(this.lives=0),
this.invaders.map(function(e,s){var o=!1;i.rockets.map(function(s,n){s.x>=e.x-e.width/2&&s.x<=e.x+e.width/2&&s.y>=e.y-e.height/2&&s.y<=e.y+e.height/2&&(i.rockets.splice(n--,1),
...
t.sounds.playSound("explosion"))}),t.lives<=0&&t.moveToState(new GameOverState),0===i.boss.hp&&0===this.endcount){this.bossbombs=[],this.bombs=[];for(var r=0;r<6;r++)i.bossexplosion.push(new ExplosionBoss(i.boss.x,i.boss.y+i.boss.height/2,r,i.bombMinVelocity+Math.random()*(i.bombMaxVelocity-i.bombMinVelocity)));
}0===i.boss.hp&&(this.endcount+=1,console.log(this.endcount)),0===i.boss.hp&&200===this.endcount&&(i.bossexplosion=[],t.score+=50*i.level,t.level+=1,t.moveToState(new LevelIntroState(t.level)));
...
i.fillRect(t.x-t.width/2,t.y-t.height/2,t.width,t.height)}),this.boss.hp>0&&(i.fillStyle="rgb(255,"+Math.floor(boss.hp/4).toString()+",11)",i.fillRect(boss.x-boss.width/2,boss.y-boss.height/2,boss.width,boss.height)),
...
});var s=t.gameBounds.bottom+(t.height-t.gameBounds.bottom)/2+7;i.font="14px Arial",i.fillStyle="#ffffff";var o="Lives: "+t.lives;i.textAlign="left",i.fillText(o,t.gameBounds.left,s),
o="Score: "+t.score+", Level: "+t.level,i.textAlign="right",i.fillText(o,t.gameBounds.right,s),this.config.debugMode&&(i.strokeStyle="#ff0000",i.strokeRect(0,0,t.width,t.height),
